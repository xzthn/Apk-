...
interface IRealsilDfu {
    ...
    boolean setDfuServiceUUID(String dfuServiceUUID);
    boolean setDfuServiceControlPointCharacCharacUUID(String dfuServiceControlCharacUUID);
    boolean setDfuServiceDataCharacUUID(String dfuServiceDataCharacUUID);
    String getDfuServiceUUID();
    String getDfuServiceControlPointCharacCharacUUID();
    String getDfuServiceDataCharacUUID();
    int getWorkMode();
